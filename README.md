...
Proyek ini dibuat untuk keperluan kompetisi/hackathon. Seluruh hak cipta dimiliki oleh tim ARCANA.penyandang disabilitas dengan perusahaan-perusahaan inklusif. Platform ini menggunakan teknologi *Semantic Job Matching* dengan model bahasa SBERT (Sentence-BERT) untuk menghasilkan rekomendasi pekerjaan yang relevan, akurat, dan inklusif.
