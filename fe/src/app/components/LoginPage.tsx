...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(data.user.role === "kandidat" ? "/kandidat/profile" : "/perusahaan/post-job");
    } catch (err: any) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "var(--font-body)" }}>
      {!isMobile && <BrandPanel />}
      <div style={{ flex: 1, background: "var(--color-bg)", display: "flex", alignItems: "center", justifyContent: "center", padding: isMobile ? "32px 20px" : "48px" }}>
        <div style={{ width: "100%", maxWidth: 420 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-heading)", fontSize: isMobile ? 26 : 32, fontWeight: 700, color: "var(--color-text)", margin: "0 0 6px" }}>Selamat Datang Kembali</h1>
          <p style={{ color: "var(--color-text-muted)", marginBottom: 32, fontSize: 14 }}>Masuk ke akun Arcana kamu</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: 8 }}>
              ...
              <div style={{ position: "relative" }}>
                <input type={showPassword ? "text" : "password"} value={password}
                  ...
                  placeholder="Password kamu" style={{ ...inputStyle("password"), paddingRight: 44 }} required />
            ...
            <div style={{ textAlign: "right", marginBottom: 24 }}>
              <span style={{ fontSize: 13, color: "var(--color-primary)", cursor: "pointer", fontWeight: 600 }}>Lupa password?</span>
            </div>
          ...
          <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "var(--color-text-muted)" }}>
            Belum punya akun?{" "}
            <span onClick={() => navigate("/register")} style={{ color: "var(--color-primary)", cursor: "pointer", fontWeight: 600 }}>Daftar</span>
          </p>
        </div>
      </div>
    </div>
